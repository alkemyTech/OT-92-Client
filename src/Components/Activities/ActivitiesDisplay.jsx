...
<p className="h3 mb-5">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis, nisi neque </p>
        <div className="row mt-5 mb-5">
            <div className="col-2">
                <div className="col-12 card">
              <img src="https://images.unsplash.com/photo-1561154464-82e9adf32764?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60" className="card-img-top img-responsive" alt="..."/>
              <div className="card-body">
    ...
    <footer className="bg-primary">Simulando footer</footer>
    </>
     );
